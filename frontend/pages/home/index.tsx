  ...
  return (
    <div className="w-full max-w-full md:max-w-md">
        ...
        <Modal open={showModal} onClose={() => setShowModal(false)}>
          {
            currentPost ?
              <div style={{ transform: 'translate(-50%, -50%)', zIndex: 1000 }} className="fixed top-1/2 left-1/2 bg-[#000000] h-[90%] w-[80%] overflow-y-scroll xl:overflow-y-hidden">
                <div className="flex flex-col xl:flex-row h-full">
                  <div className="mx-auto h-full">
                    <img src={currentPost.image} alt="Heya" className="max-h-full mx-auto" />
                  </div>
